...
const readNumOfBlocks = async (blockNumber, n, debug) => {
    // const blockNumber = await getBlockNumber();
    let i;
    let tbn = blockNumber+n;
    let contracttrs = [];
    for(i=0;i<=n;i++){
    ...
    if(debug) console.log('contract creation trxs',contracttrs);
}

readNumOfBlocks(UNIV2_CREATION_BLOCKNUMBER, 100, true);
