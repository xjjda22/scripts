...
const CHAINLINK_UNIUSD_CONTRACT_ADDRESS = "0x553303d460ee0afb37edff9be42922d8ff63220e";
const CHAINLINK_SUSHIUSD_CONTRACT_ADDRESS = "0xcc70f09a6cc17553b2e31954cd36e4a2d89501f7";
...
const chainLinkUNIUSD = new Contract(CHAINLINK_UNIUSD_CONTRACT_ADDRESS, CHAINLINK_PRICEFEED_ABI, provider);
const chainLinkSUSHIUSD = new Contract(CHAINLINK_SUSHIUSD_CONTRACT_ADDRESS, CHAINLINK_PRICEFEED_ABI, provider);
